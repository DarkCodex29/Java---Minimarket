 ...
 * @author Gianx
 */
public class frm_Detalle_Compra extends javax.swing.JInternalFrame {
    ...
    void consultar(String cod){
        DefaultTableModel model = new DefaultTableModel(); 
         ...
         ListaEnlazada datos = DetalleCompra.cosultarDetalleCompra(cod);              
